...
%% Sweave
\SweaveOpts{eval=TRUE,echo=TRUE,eps=FALSE,results=verbatim,keep.source=TRUE,prefix.string=figures/figure}
...
\SweaveInput{src/histogram.Rnw}

\clearpage
\SweaveInput{src/inversion.Rnw}
