...
test_that("[011] calling uerror with Runuran: cont, aqdist", {
...
test_that("[021] calling xerror with Runuran: cont, aqdist", {
        unr <- pinvd.new(udnorm(mean=1,sd=2), uresolution=1.e-12)
...
test_that("[i11] calling rvgt.ftable (Runuran) with invalid arguments: multivariate", {
...
test_that("[i12] calling uerror (Runuran) with invalid arguments: discrete", {
...
test_that("[i12] calling xerror (Runuran) with invalid arguments: discrete", {
...
test_that("[i21] calling uerror (Runuran) with invalid arguments: TDR", {
...
test_that("[i22] calling xerror (Runuran) with invalid arguments: TDR", {
